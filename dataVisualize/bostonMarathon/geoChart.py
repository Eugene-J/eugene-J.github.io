...
# Load the CSV file
marathon_results_2017 = pd.read_csv("./dataVisualize/bostonMarathon/data/marathon_results_2017.csv")
...
plt.subplots(marathon_count.Lat, marathon_count.Long, s=marathon_count.count, alpha=0.5)
